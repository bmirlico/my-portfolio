      ...
      <div className="container-custom">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed animate-fade-up opacity-0 stagger-2">
            A passionate <span className="text-foreground font-medium">fullstack developer</span> and{" "}
            <span className="text-foreground font-medium">technical writer</span> crafting
            modern web experiences. I love building products that make a difference
