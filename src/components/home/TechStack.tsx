...
const CursorIcon = ({ className }: { className?: string }) => (
	<svg className={className} viewBox="400 395 167 190" fill="currentColor" aria-label="Cursor">
		<title>Cursor</title>
...
const ClaudeIcon = ({ className }: { className?: string }) => (
	<svg className={className} viewBox="0 0 16 16" fill="#D97757" aria-label="Claude">
		<title>Claude</title>
